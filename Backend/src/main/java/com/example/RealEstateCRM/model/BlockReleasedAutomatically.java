...
@Data
@Entity
@Table(name = "BlockReleasedAutomatically")
public class BlockReleasedAutomatically {


    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private Long blockReleasedAutometicallyId;
    ...
    private String siteVisitEmpCode;
    private String siteVisitEmpName;
    private String blockEmpCode;
    ...
    public String getSiteVisitEmpCode() {
        return siteVisitEmpCode;
    }

    public void setSiteVisitEmpId(String siteVisitEmpId) {
        this.siteVisitEmpCode = siteVisitEmpId;
    }
