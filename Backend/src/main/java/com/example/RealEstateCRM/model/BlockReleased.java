...
@Data
@Entity
@Table(name = "BlockReleased")
public class BlockReleased {
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private Long blockReleasedId;
    ...
    public Long getBlockReleasedId() {
        return blockReleasedId;
    }

    public void setBlockReleasedId(Long blockReleasedId) {
        this.blockReleasedId = blockReleasedId;
    }
