...
public class Booking {
    ...
    private Double paidAmountInBlock;
    ...
    public String getBookingEmpId() {
        return bookingEmpId;
    }

    public void setBookingEmpId(String bookingEmpId) {
        this.bookingEmpId = bookingEmpId;
    }

    public String getBookingEmpNAme() {
        return bookingEmpNAme;
    }

    public void setBookingEmpNAme(String bookingEmpNAme) {
        this.bookingEmpNAme = bookingEmpNAme;
    }
