...
--
-- Table structure for table `block_released_automatically`
--

DROP TABLE IF EXISTS `block_released_automatically`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `block_released_automatically` (
  `block_released_autometically_id` bigint NOT NULL,
  `address` varchar(255) DEFAULT NULL,
  `area` varchar(255) DEFAULT NULL,
  `bank_name` varchar(255) DEFAULT NULL,
  `block_emp_code` varchar(255) DEFAULT NULL,
  `block_emp_name` varchar(255) DEFAULT NULL,
  `blocks_id` bigint DEFAULT NULL,
  ...
  `site_visit_emp_code` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`block_released_autometically_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `block_released_automatically`
--

LOCK TABLES `block_released_automatically` WRITE;
/*!40000 ALTER TABLE `block_released_automatically` DISABLE KEYS */;
/*!40000 ALTER TABLE `block_released_automatically` ENABLE KEYS */;
UNLOCK TABLES;
