...
--
-- Table structure for table `block_released`
--

DROP TABLE IF EXISTS `block_released`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `block_released` (
  `block_released_id` bigint NOT NULL,
  ...
  PRIMARY KEY (`block_released_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `block_released`
--

LOCK TABLES `block_released` WRITE;
/*!40000 ALTER TABLE `block_released` DISABLE KEYS */;
/*!40000 ALTER TABLE `block_released` ENABLE KEYS */;
UNLOCK TABLES;
